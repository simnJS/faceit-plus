...
const MESSAGES = {
  fr: {
    ...
    'veto.banAdviceModel': 'Meilleur ban selon le modèle : +{delta} points de winrate espérés sur la map finale',
  ...
  en: {
    ...
    'veto.banAdviceModel': 'Best ban per the model: +{delta} expected winrate points on the final map',
